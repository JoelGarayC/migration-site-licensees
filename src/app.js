...
const createLicenseeUrl = `${apiLicensing}/licensee/create?aid=${aid}&api_token=${apiToken}`
const createContractUrl = `${apiLicensing}/contract/create?aid=${aid}&api_token=${apiToken}`
const createContractUserUrl = `${apiLicensing}/contractUser/create?aid=${aid}&api_token=${apiToken}`
